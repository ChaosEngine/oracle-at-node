...
module.exports = {
	user: process.env.NODE_ORACLEDB_USER || "USERUSERUSER",
	...
	// needed.
	password: process.env.NODE_ORACLEDB_PASSWORD || "PASSPASSPASSPASS",

	// For information on connection strings see:
	// https://oracle.github.io/node-oracledb/doc/api.html#connectionstrings
	connectString: process.env.NODE_ORACLEDB_CONNECTIONSTRING || "somethingsomething_medium",
